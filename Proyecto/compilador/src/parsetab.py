...
_lr_productions = [
  ...
  ('program -> block','program',1,'p_program','analizador_sintatico.py',23),
  ('block -> constDecl varDecl procDecl statement','block',4,'p_block','analizador_sintatico.py',28),
  ('constDecl -> CONST constAssignmentList SEMMICOLOM','constDecl',3,'p_constDecl','analizador_sintatico.py',32),
  ('constDecl -> empty','constDecl',1,'p_constDeclEmpty','analizador_sintatico.py',37),
  ('constAssignmentList -> ID ASSIGN NUMBER','constAssignmentList',3,'p_constAssignmentList1','analizador_sintatico.py',42),
  ('constAssignmentList -> constAssignmentList COMMA ID ASSIGN NUMBER','constAssignmentList',5,'p_constAssignmentList2','analizador_sintatico.py',46),
  ('varDecl -> VAR identList SEMMICOLOM','varDecl',3,'p_varDecl1','analizador_sintatico.py',50),
  ('varDecl -> empty','varDecl',1,'p_varDeclEmpty','analizador_sintatico.py',54),
  ('identList -> ID','identList',1,'p_identList1','analizador_sintatico.py',58),
  ('identList -> identList COMMA ID','identList',3,'p_identList2','analizador_sintatico.py',62),
  ('procDecl -> procDecl PROCEDURE ID SEMMICOLOM block SEMMICOLOM','procDecl',6,'p_procDecl1','analizador_sintatico.py',66),
  ('procDecl -> empty','procDecl',1,'p_procDeclEmpty','analizador_sintatico.py',70),
  ('statement -> ID UPDATE expression','statement',3,'p_statement1','analizador_sintatico.py',74),
  ('statement -> CALL ID','statement',2,'p_statement2','analizador_sintatico.py',78),
  ('statement -> BEGIN statementList END','statement',3,'p_statement3','analizador_sintatico.py',82),
  ('statement -> IF condition THEN statement','statement',4,'p_statement4','analizador_sintatico.py',86),
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','analizador_sintatico.py',90),
  ('statement -> empty','statement',1,'p_statementEmpty','analizador_sintatico.py',94),
  ('statementList -> statement','statementList',1,'p_statementList1','analizador_sintatico.py',98),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','analizador_sintatico.py',102),
  ('condition -> ODD expression','condition',2,'p_condition1','analizador_sintatico.py',106),
  ('condition -> expression relation expression','condition',3,'p_condition2','analizador_sintatico.py',110),
  ('relation -> ASSIGN','relation',1,'p_relation1','analizador_sintatico.py',114),
  ('relation -> NE','relation',1,'p_relation2','analizador_sintatico.py',118),
  ('relation -> LT','relation',1,'p_relation3','analizador_sintatico.py',122),
  ('relation -> GT','relation',1,'p_relation4','analizador_sintatico.py',126),
  ('relation -> LTE','relation',1,'p_relation5','analizador_sintatico.py',130),
  ('relation -> GTE','relation',1,'p_relation6','analizador_sintatico.py',134),
  ('expression -> term','expression',1,'p_expression1','analizador_sintatico.py',138),
  ('expression -> addingOperator term','expression',2,'p_expression2','analizador_sintatico.py',142),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','analizador_sintatico.py',146),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','analizador_sintatico.py',150),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','analizador_sintatico.py',154),
  ('term -> factor','term',1,'p_term1','analizador_sintatico.py',158),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','analizador_sintatico.py',162),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','analizador_sintatico.py',166),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','analizador_sintatico.py',170),
  ('factor -> ID','factor',1,'p_factor1','analizador_sintatico.py',174),
  ('factor -> NUMBER','factor',1,'p_factor2','analizador_sintatico.py',178),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','analizador_sintatico.py',182),
  ('empty -> <empty>','empty',0,'p_empty','analizador_sintatico.py',186),
]
